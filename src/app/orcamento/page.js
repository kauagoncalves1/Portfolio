...
const QUOTE_ITEMS = [
  ...
  { id: "admin", name: "Painel administrativo", desc: "Login, gestão de conteúdo/pedidos, dashboard.", price: 800 },
  ...
  { id: "analytics", name: "Dashboard de analytics", desc: "Gráficos e métricas do negócio em tempo real.", price: 500 },
  { id: "ecommerce", name: "Loja / pedidos online", desc: "Catálogo, carrinho e simulação de pedidos.", price: 1200 },
        ...
        <div className="wrap">
          <div className="quote-layout" data-reveal>
            ...
            <div className="quote-summary">
              <h3>Resumo</h3>
              <p className="qs-hint">
                Valores de referência (placeholder) — ajustáveis conforme escopo real
                do projeto.
              </p>
