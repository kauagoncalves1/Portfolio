...
const projects = [
  ...
  {
    title: 'Portfólio v1',
    description: 'Primeiro portfólio pessoal criado com HTML, CSS e JavaScript puro. Ponto de partida da minha evolução como desenvolvedor.',
    tags: ['HTML', 'CSS', 'JavaScript'],
    github: 'https://github.com/kauagoncalves1/Meu-Portifolio',
    live: 'https://kauagoncalves1.github.io/Meu-Portifolio/',
  },
  {
  title: 'Portfólio v2 (Este)',
